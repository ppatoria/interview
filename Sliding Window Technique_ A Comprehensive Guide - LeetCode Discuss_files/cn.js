...
var signInBtnId = '#navbar_sign_in_button' // used to check sign in state in FrontendX
var avatarId = '#navbar_user_avatar' // used to check sign in state in FrontendX
...
var isFromChinaPromise = !!asideEle
  ...
  : new Promise(function(resolve) {
      ...
      ckIpScript.src = `//leetcode.cn/api/is_china_ip/?callback=afterCheckCnIp`
...
var isSignedInPromise = !!window.LeetCodeData
  ...
  : new Promise(function(resolve) {
      ...
      var checkIfHasAuthLinks = function() {
        if (document.querySelector('div[class*="auth-links"]') || document.querySelector(signInBtnId)) {
          resolve(false);
          return;
        }
        if (document.querySelector('svg[class*="account-icon"]') || document.querySelector(avatarId)) {
          resolve(true);
          return;
        }
        times -= 1;
...
function autoRedirect2China() {
  ...
  window.location.href = `https://leetcode.cn${redirectingPath}?utm_source=LCUS&utm_medium=ip_redirect&utm_campaign=transfer2china`
}
...
function renderTransfer2CnBar(isSignedIn, retryCount) {
  ...
  <div class="banner-inner">
    <div style="position: relative; height: 100%; width: 100%;">
      <a href="https://support.leetcode.cn/hc/kb/article/1286274/${utmLink}&utm_content=img">
        <img class="ba-img" src="https://assets.leetcode.cn/lccn-resources/profile.svg" />
      </a>
      <div style="margin-left: 170px">
        <div>
          力扣「<a href="https://leetcode.cn/problemset/all/${utmLink}&utm_content=title_main" style="font-weight: bold;">中文社区</a>」现已上线，
          全新「<a href="https://support.leetcode.cn/hc/kb/article/1286061/${utmLink}&utm_content=title_profile_help" style="font-weight: bold;">个人主页</a>」更优体验，
          <a href="https://leetcode.cn/problemset/all/${utmLink}&utm_content=title_go">即刻加入先人一步攒积分！</a>
        </div>
        <div style="font-size: 12px; margin-top: 5px; margin-bottom: 10px;">
          <span style="opacity: 0.7;">新功能推荐：
            <a href="https://leetcode.cn/store/${utmLink}&utm_content=sub_store" style="color: rgba(239,108,0,1); font-weight: bold;">🎁 全新积分商场礼品</a> &nbsp;| &nbsp;
            <a href="https://support.leetcode.cn/hc/kb/article/1277893/${utmLink}&utm_content=sub_solution" >上万社区题解</a> &nbsp;| &nbsp;
            <a href="https://support.leetcode.cn/hc/kb/article/1278078/${utmLink}&utm_content=sub_company" >企业题库</a> &nbsp;| &nbsp;
            <a href="https://support.leetcode.cn/hc/kb/article/1278079/${utmLink}&utm_content=sub_mock" >面试模拟</a> &nbsp;| &nbsp;
            <a href="https://leetcode.cn/contest/${utmLink}&utm_content=sub_contest" >更多竞赛</a> &nbsp;| &nbsp;
            <a href="https://support.leetcode.cn/hc/kb/article/1252597/${utmLink}&utm_content=sub_sync" style="color: rgba(239,108,0,1);">轻松数据同步使用已有积分</a>
          </span>
        </div>
      </div>
  ...
  // question detail pages
    ...
    var nextEle = document.querySelector('#__next')
    containerElement = nextEle || document.querySelector('body > #app > div[class*="layout"]');
    containerElement && containerElement.insertBefore(newPgBanner, containerElement.children[nextEle?0:1]);
  } else if(location.pathname.match(/^\/problemset\//)) {
    containerElement = document.querySelector('#__next');
    containerElement && containerElement.insertBefore(newPgBanner, containerElement.children[0]);
  } 
  else {
